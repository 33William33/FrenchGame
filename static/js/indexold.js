    ...
    window.addEventListener("load", function() {
        ...
        function updateGraph() {
            apiService.getGraphs(function(err, imgts) {
                ...
                imgts.forEach(function(imgt) {
                    let element = document.createElement("div");
                    element.className = "user";
                    element.innerHTML = `
                         <div class="imgt">${imgt.imageName}</div>
                        <img src="${imgt.url}"/>
                    `;
        ...
        function createImage(title, id, author, url) {
                    ...
                    apiService.getCmtList(id, page).forEach(function(cmt) {
                        ...
                        elmt
                            ...
                            .addEventListener("click", function(e) {
                                ...
                                apiService.deleteComment(commentId, function(err, comment) {
                                    if (err) return onError(err)
                                });
                                updateComments(id, 0);
                            });
